 ...
 * @generated
 */
public class ConceptMapDSLSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ConceptMapDSLPackage modelPackage;
	 ...
	 * @generated
	 */
	public ConceptMapDSLSwitch() {
		if (modelPackage == null) {
			modelPackage = ConceptMapDSLPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConceptMapDSLPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConceptMapDSLPackage.CONCEPT_MAP: {
				ConceptMap conceptMap = (ConceptMap)theEObject;
				T result = caseConceptMap(conceptMap);
				if (result == null) result = caseNamedElement(conceptMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConceptMapDSLPackage.MAP_ELEMENTS: {
				MapElements mapElements = (MapElements)theEObject;
				T result = caseMapElements(mapElements);
				if (result == null) result = caseNamedElement(mapElements);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Map Elements</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Map Elements</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMapElements(MapElements object) {
		return null;
	}
