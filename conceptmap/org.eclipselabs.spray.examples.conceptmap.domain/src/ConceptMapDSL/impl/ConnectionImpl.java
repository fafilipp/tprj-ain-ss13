 ...
 * <ul>
 *   <li>{@link ConceptMapDSL.impl.ConnectionImpl#getFromElement <em>From Element</em>}</li>
 *   <li>{@link ConceptMapDSL.impl.ConnectionImpl#getToElement <em>To Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConnectionImpl extends MapElementsImpl implements Connection {
	/**
	...
	protected EClass eStaticClass() {
		return ConceptMapDSLPackage.Literals.CONNECTION;
	}
		...
		if (fromElement != null && fromElement.eIsProxy()) {
			...
			if (fromElement != oldFromElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptMapDSLPackage.CONNECTION__FROM_ELEMENT, oldFromElement, fromElement));
			}
		}
		return fromElement;
	}
	...
	public void setFromElement(Element newFromElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptMapDSLPackage.CONNECTION__FROM_ELEMENT, oldFromElement, fromElement));
	}
	...
	public Element getToElement() {
		if (toElement != null && toElement.eIsProxy()) {
			...
			if (toElement != oldToElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptMapDSLPackage.CONNECTION__TO_ELEMENT, oldToElement, toElement));
			}
		}
		return toElement;
	}
	...
	public void setToElement(Element newToElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptMapDSLPackage.CONNECTION__TO_ELEMENT, oldToElement, toElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptMapDSLPackage.CONNECTION__FROM_ELEMENT:
				if (resolve) return getFromElement();
				return basicGetFromElement();
			case ConceptMapDSLPackage.CONNECTION__TO_ELEMENT:
