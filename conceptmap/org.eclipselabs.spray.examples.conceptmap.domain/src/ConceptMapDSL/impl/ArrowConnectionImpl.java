...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Arrow Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ConceptMapDSL.impl.ArrowConnectionImpl#getFromElement <em>From Element</em>}</li>
 *   <li>{@link ConceptMapDSL.impl.ArrowConnectionImpl#getToElement <em>To Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ArrowConnectionImpl extends MapElementsImpl implements ArrowConnection {
	/**
	...
	protected EClass eStaticClass() {
		return ConceptMapDSLPackage.Literals.ARROW_CONNECTION;
	}
		...
		if (fromElement != null && fromElement.eIsProxy()) {
			...
			if (fromElement != oldFromElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptMapDSLPackage.ARROW_CONNECTION__FROM_ELEMENT, oldFromElement, fromElement));
			}
		}
		return fromElement;
	}
	...
	public void setFromElement(Element newFromElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptMapDSLPackage.ARROW_CONNECTION__FROM_ELEMENT, oldFromElement, fromElement));
	}
	...
	public Element getToElement() {
		if (toElement != null && toElement.eIsProxy()) {
			...
			if (toElement != oldToElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptMapDSLPackage.ARROW_CONNECTION__TO_ELEMENT, oldToElement, toElement));
			}
		}
		return toElement;
	}
	...
	public void setToElement(Element newToElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptMapDSLPackage.ARROW_CONNECTION__TO_ELEMENT, oldToElement, toElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptMapDSLPackage.ARROW_CONNECTION__FROM_ELEMENT:
				if (resolve) return getFromElement();
				return basicGetFromElement();
			case ConceptMapDSLPackage.ARROW_CONNECTION__TO_ELEMENT:
