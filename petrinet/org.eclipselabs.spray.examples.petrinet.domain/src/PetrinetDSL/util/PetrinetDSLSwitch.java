...
public class PetrinetDSLSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetrinetDSLPackage.PETRINET: {
				Petrinet petrinet = (Petrinet)theEObject;
				T result = casePetrinet(petrinet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetDSLPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = casePetrinet(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetDSLPackage.EDGE: {
				Edge edge = (Edge)theEObject;
				T result = caseEdge(edge);
				if (result == null) result = casePetrinet(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetDSLPackage.TOKEN: {
				Token token = (Token)theEObject;
				T result = caseToken(token);
				if (result == null) result = caseNode(token);
				if (result == null) result = casePetrinet(token);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetDSLPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = caseNode(transition);
				if (result == null) result = casePetrinet(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetDSLPackage.PLACE: {
				...
				if (result == null) result = casePetrinet(place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetDSLPackage.PT_EDGE: {
				PTEdge ptEdge = (PTEdge)theEObject;
				T result = casePTEdge(ptEdge);
				if (result == null) result = caseEdge(ptEdge);
				if (result == null) result = casePetrinet(ptEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Petrinet</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Petrinet</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PT Edge</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PT Edge</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
