 ...
 * <ul>
 *   <li>{@link PetrinetDSL.impl.PetrinetImpl#getPlaces <em>Places</em>}</li>
 *   <li>{@link PetrinetDSL.impl.PetrinetImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetrinetImpl extends NamedElementImpl implements Petrinet {
	...
	public EList<Place> getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList<Place>(Place.class, this, PetrinetDSLPackage.PETRINET__PLACES);
		}
		return places;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, PetrinetDSLPackage.PETRINET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetDSLPackage.PETRINET__PLACES:
				return ((InternalEList<?>)getPlaces()).basicRemove(otherEnd, msgs);
			case PetrinetDSLPackage.PETRINET__TRANSITIONS:
