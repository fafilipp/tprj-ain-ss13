...
public class ElementImpl extends MapElementsImpl implements Element {
	 ...
	 * @generated
	 */
	public MapElements getParent() {
		if (parent != null && parent.eIsProxy()) {
			InternalEObject oldParent = (InternalEObject)parent;
			parent = (MapElements)eResolveProxy(oldParent);
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MindmapPackage.ELEMENT__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	 ...
	 * @generated
	 */
	public MapElements basicGetParent() {
		return parent;
	}
	 ...
	 * @generated
	 */
	public void setParent(MapElements newParent) {
		MapElements oldParent = parent;
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindmapPackage.ELEMENT__PARENT, oldParent, parent));
	}
